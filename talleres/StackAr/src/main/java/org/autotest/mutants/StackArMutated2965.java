...
/**
 * FalseConditionalsMutator: Se reemplazó la condición '!java.util.Arrays.equals(elems, other.elems)' por false en la línea 79.
 */
public class StackArMutated2965 extends org.autotest.Stack {
    ...
    public StackArMutated2965() {
        this(org.autotest.mutants.StackArMutated2965.DEFAULT_CAPACITY);
    }

    public StackArMutated2965(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated2965 other = ((org.autotest.mutants.StackArMutated2965) (obj));
        if (false) {
            return false;
        }
