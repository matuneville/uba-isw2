...
/**
 * TrueConditionalsMutator: Se reemplazó la condición '!java.util.Arrays.equals(elems, other.elems)' por true en la línea 79.
 */
public class StackArMutated9387 extends org.autotest.Stack {
    ...
    public StackArMutated9387() {
        this(org.autotest.mutants.StackArMutated9387.DEFAULT_CAPACITY);
    }

    public StackArMutated9387(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated9387 other = ((org.autotest.mutants.StackArMutated9387) (obj));
        if (true) {
            return false;
        }
